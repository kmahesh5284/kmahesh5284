...
/* added the below stuff according to https://review.coreboot.org/c/coreboot/+/70262/5/src/drivers/wifi/generic/acpi.c#605 
	child = dev->link_list ? dev->link_list->children : NULL;
