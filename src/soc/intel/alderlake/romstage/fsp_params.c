		...
		const struct soc_intel_alderlake_config *config)
{
	...
	printk(BIOS_DEBUG, "User_info_The value of pcieRpEnableMask is %x\n:", m_cfg->PcieRpEnableMask);
	printk(BIOS_DEBUG, "User_info_The value of pcieRpEnableMask is 0x%X\n:", m_cfg->PcieRpEnableMask);
	printk(BIOS_DEBUG, "User_info_The value of pcieRpEnableMask is %d\n:", m_cfg->PcieRpEnableMask);
